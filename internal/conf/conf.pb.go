...
const file_conf_proto_rawDesc = "" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x12G\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationB\x12\xbaH\x0f\xc8\x01\x01\xaa\x01\t\"\x03\b\xd8\x04*\x02\b\x01R\atimeout\"\xf4\x02\n" +
	"\x04Data\x12/\n" +
	"\bdatabase\x18\x01 \x01(\v2\x13.conf.Data.DatabaseR\bdatabase\x12&\n" +
	"\x05redis\x18\x02 \x01(\v2\x10.conf.Data.RedisR\x05redis\x12!\n" +
	"\x05trace\x18\x03 \x01(\v2\v.conf.TraceR\x05trace\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\"\x19\n" +
	"\x05Trace\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\"\xe2\x01\n" +
	"\x03Log\x12\x19\n" +
...
var file_conf_proto_depIdxs = []int32{
	...
	5,  // 2: conf.Bootstrap.log:type_name -> conf.Log
	...
	4,  // 7: conf.Data.trace:type_name -> conf.Trace
	0,  // 8: conf.Log.log_level:type_name -> conf.LogLevel
	10, // 9: conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	10, // 10: conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
